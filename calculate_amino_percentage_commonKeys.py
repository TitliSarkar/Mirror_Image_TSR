...
filesList = [f.split("/")[4].split(".")[0] for f in glob.glob(directory+"*.commonTriplets_29_35")]
...
def calculate_amino_acid_percentage_parallel(p, unchanged, changed):
    ...
    f_in= open(directory+p+".commonTriplets_29_35","r")
...
f_out = open(directory+"44PKABC_amino_percentage_commonKeys.txt", "w")
for f in filesList:
